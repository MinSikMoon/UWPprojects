...
void UWPPenAppDraft::GridContent::makeImage(Grid^ parentGrid, int rowIdx, int columnIdx) {
	Image^ tempImage = ref new Image();
	tempImage->Style = TEST_IMAGE;
	tempImage->SetValue(parentGrid->ColumnProperty, columnIdx);
	tempImage->SetValue(parentGrid->RowProperty, rowIdx);
...
{
	//GridElem^ newGridElem = ref new GridElem(1, UWPPenAppDraft::ACTIVITY, PageGrid, curRowIdx, curColumnIdx);
...
////////gridElem
//void UWPPenAppDraft::GridElem::makeMemoButton(Grid^ parentGrid, int horizontal, int vertical, int width, int height, int rowIdx, int columnIdx) {
//	Button^ tempButton = ref new Button();
//	tempButton->Style = BUTTON_STYLE_ARROW;
//	tempButton->Width = width;
//	tempButton->Height = height;
...
//}
//
//void UWPPenAppDraft::GridElem::makeConnectorButton(Grid^ parentGrid, int horizontal, int vertical, int width, int height, int rowIdx, int columnIdx) {
//
//}
//
